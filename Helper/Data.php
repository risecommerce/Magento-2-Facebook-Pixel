 ...
 */
namespace Risecommerce\FacebookPixel\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Get pixel Id from system config
     *
     * @param null $scope
     * @return mixed
     */
    public function getPixelId($scope = null)
    {
        return $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/general/pixel_id',
    ...
    /**
     * Get disabled page list for event tracking from system config
     *
     * @param null $scope
     * @return array
     */
    public function getDisablePageList($scope = null)
    {
        $lists = $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/event_tracking/disable_code',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
        if ($lists) {
    ...
    /**
     * Get price include tax from system config
     *
     * @param null $scope
     * @return mixed
     */
    ...
    /**
     * Get event tracking for category view enable or not from system config
     *
     * @param null $scope
     * @return mixed
     */
    ...
    {
        return $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/event_tracking/category_view',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
    ...
    /**
     * Get event tracking for view product content enable or not from system config
     *
     * @param null $scope
     * @return mixed
     */
    ...
    {
        return $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/event_tracking/product_view',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
    ...
    /**
     * Get event tracking for add to wishlist enable or not
     *
     * @param null $scope
     * @return mixed
     */
    ...
    {
        return $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/event_tracking/add_to_wishlist',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
    ...
    /**
     * Get event tracking for search enable or not
     *
     * @param null $scope
     * @return mixed
     */
    ...
    {
        return $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/event_tracking/search',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
    ...
    /**
     * Get event tracking for purchase enable or not
     *
     * @param null $scope
     * @return mixed
     */
    ...
    {
        return $this->scopeConfig->getValue(
            'risecommerce_facebook_pixel/event_tracking/purchase',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
